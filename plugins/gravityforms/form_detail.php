...
class GFFormDetail{
    ...
    public static function forms_page($form_id){
        ...
        <script type="text/javascript">
            var gf_global = {
                "gf_currency_config" : <?php echo json_encode(RGCurrency::get_currency(GFCommon::get_currency()));?>
            };
            ...
            var gf_vars = {
                ...
                "enterValue" : "<?php _e("Enter a value", "gravityforms"); ?>",
        ...
        <script src="<?php echo GFCommon::get_base_url() ?>/js/jquery.placeholder.1.2.min.js?ver=<?php echo GFCommon::$version ?>"></script>
                ...
                <td class="pad_top" valign="top">
                    ...
                    <div id="gform_heading" class="selectable">
                        ...
                        <div id="form_settings" style="display:none;">
                            ...
                            <div id="gform_settings_tab_3">
                                <ul class="gforms_form_settings">
                                    <?php do_action("gform_confirmation_settings", 100, $form_id); ?>
                                    <li>
                                    ...
                                    <?php do_action("gform_confirmation_settings", 200, $form_id); ?>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="after_insert_dialog" style="display:none;">
                            ...
                            <div class="new-form-option"><a title="<?php _e("Preview this form", "gravityforms"); ?>" id="preview_form_link" href="<?php echo site_url() ?>/?gf_page=preview&id={formid}" target="_blank"><?php _e("Preview this Form", "gravityforms"); ?></a></div>
                    ...
                    <div id="field_settings" style="display: none;">
                        ...
                        <div id="gform_tab_1">
                            ...
                            <li class="content_setting field_setting">
                                ...
                                <?php self::insert_variable_prepopulate("field_content", "HtmlContentCallback") ?><br/>
                        ...
                        <div id="gform_tab_2">
                            <ul>
                                ...
                                <li class="default_value_setting field_setting">
                                    ...
                                    <?php self::insert_variable_prepopulate("field_default_value", "DefaultValueCallback") ?><br/>
                    ...
                    <div id="add_fields">
                        <div id="floatMenu">
                            ...
                            <div class="updated_base" id="after_update_dialog" style="display:none;">
                                ...
                                &nbsp;<a title="<?php _e("Preview this form", "gravityforms"); ?>" href="<?php echo site_url() ?>/?gf_page=preview&id=<?php echo absint(rgar($form, "id")) ?>" target="_blank"><?php _e("Preview", "gravityforms"); ?></a></strong>
                            </div>
