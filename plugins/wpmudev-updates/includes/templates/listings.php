...
<div style="display:none" id="_installed-placeholder"><span href="#" class="button"><i class="icon-ok icon-large"></i><?php echo is_multisite() ? __('INSTALLED', 'wpmudev') : __('INSTALLED & ACTIVATED', 'wpmudev'); ?></span></div>
