...
class pb_backupbuddy_ui {
	 ...
	 */
	public function alert( $message, $error = false, $error_code = '' ) {
		$log_error = false;
		...
		if ( $error_code != '' ) {
			$message .= '<p><a href="http://ithemes.com/codex/page/' . pb_backupbuddy::settings( 'name' ) . ':_Error_Codes#' . $error_code . '" target="_new"><i>' . pb_backupbuddy::settings( 'name' ) . ' Error Code ' . $error_code . ' - Click for more details.</i></a></p>';
			$log_error = true;
		}
		if ( $log_error === true ) {
