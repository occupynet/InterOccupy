...
require_once pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Signature/Common.php';
require_once pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Exception/NotImplemented.php';
