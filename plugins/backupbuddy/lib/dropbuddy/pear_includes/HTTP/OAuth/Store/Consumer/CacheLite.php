...
require_once pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Store/Data.php';
require_once pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Store/Consumer/Interface.php';
require_once pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/Cache/Lite.php';
