...
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Consumer/Request.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Consumer/Exception/InvalidResponse.php' );
