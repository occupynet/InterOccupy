...
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/Request2.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/Request2/Observer/Log.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Message.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Consumer/Response.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Signature.php' );
require_once( pb_backupbuddy::plugin_path() . '/lib/dropbuddy/pear_includes/HTTP/OAuth/Exception.php' );
