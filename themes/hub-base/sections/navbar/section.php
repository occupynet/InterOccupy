	  ...
	  <div class="navbar-inner <?php echo $content_width_class;?>">
	    <div class="navbar-content-pad fix">
	      <a href="javascript:void(0)" class="nav-btn nav-btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
			...
			<?php if($passive): ?>
				<a class="plbrand" href="http://www.interoccupy.net">
					<img src="http://interoccupy.net/wp-content/themes/interoccupy/images/logo-network.png" border="0" name="Interoccupy" />
				</a>
			<?php endif; ?>
	       ...
	       <?php 	if(!$hidesearch)
					...
					wp_nav_menu( 
						array(
							...
							'menu_class'		=> 'mainmenu font-sub navline pldrop ' . $align_class, 
							'menu'				=> $menu,
							'container'			=> null, 
							'container_class'	=> '', 
							'depth'				=> 2, 
